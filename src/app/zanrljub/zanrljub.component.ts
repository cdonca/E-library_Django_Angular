...
@Component({
  selector: 'app-zanrljub',
  templateUrl: './zanrljub.component.html',
  styleUrls: ['./zanrljub.component.scss']
})
export class ZanrljubComponent {
  knjigas = [{ naziv: 'Test' }];
  selectedBook;
  ...
  getKnjigas = () => {
    this.api.getKnjigasZanrLjub().subscribe(
      data => {
        this.knjigas = data;
      },
      error => {
