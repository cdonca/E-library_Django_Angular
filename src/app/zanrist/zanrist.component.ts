...
@Component({
  selector: 'app-zanrist',
  templateUrl: './zanrist.component.html',
  styleUrls: ['./zanrist.component.scss']
})
export class ZanristComponent{
  knjigas = [{ naziv: 'Test' }];
  selectedBook;
  ...
  getKnjigas = () => {
    this.api.getKnjigasZanrIst().subscribe(
      data => {
        this.knjigas = data;
      },
      error => {
