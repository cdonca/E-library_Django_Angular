...
@Component({
  selector: 'app-zanrpub',
  templateUrl: './zanrpub.component.html',
  styleUrls: ['./zanrpub.component.scss']
})
export class ZanrpubComponent {
  knjigas = [{ naziv: 'Test' }];
  selectedBook;
  ...
  getKnjigas = () => {
    this.api.getKnjigasZanrPub().subscribe(
      data => {
        this.knjigas = data;
      },
      error => {
