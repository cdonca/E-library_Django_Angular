...
@Component({
  selector: 'app-zanrkrimi',
  templateUrl: './zanrkrimi.component.html',
  styleUrls: ['./zanrkrimi.component.scss']
})
export class ZanrkrimiComponent {
  knjigas = [{ naziv: 'Test' }];
  selectedBook;
  ...
  getKnjigas = () => {
    this.api.getKnjigasZanrKrimi().subscribe(
      data => {
        this.knjigas = data;
      },
      error => {
